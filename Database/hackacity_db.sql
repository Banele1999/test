...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2023 at 02:43 AM
...
(15, 'joel', 'manasoe', 'joel@email.com', 'tut', '123zxc', 1),
(16, 'joel', 'manasoe', 'joel1@email.com', 'tut', '123zxc', 1);
...
INSERT INTO `team` (`team_id`, `group_name`, `start_date`, `end_date`) VALUES
(1, 'TECHS', NULL, NULL),
(2, 'TVH', NULL, NULL),
(3, 'Techs', NULL, NULL),
(4, 'TVH', NULL, NULL),
(5, 'HEILBRON', NULL, NULL),
(6, 'HEILBRON', NULL, NULL),
(7, 'thobela', NULL, NULL),
(8, 'thobela', NULL, NULL),
(11, 'TECHS', NULL, NULL),
(12, 'TECHS', NULL, NULL);
...
--
ALTER TABLE `judge`
  MODIFY `judge_id` int(45) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
